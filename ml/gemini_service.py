...
IMPORTANT RULES:
- If the description contains "stolen", "stole", or "steal", classify as "Theft"
- If it mentions breaking into a building/house, classify as "Burglary"
- If it involves force or threat during theft, classify as "Robbery"
...
def classify_rule_based(description):
    ...
    # Theft keywords - PRIORITY CHECK (most common)
    # Check for "stolen" or "stole" first
    ...
    # Fraud keywords
    if any(word in desc_lower for word in ['fraud', 'scam', 'cheat', 'fake', 'counterfeit', 'forgery']):
        return "Fraud"
